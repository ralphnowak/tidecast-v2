...
function getCoordinatesForLocation(location) {
  const coords = {
    ...
    'Upper Bay Vegetation': [39.10, -76.14],
    ...
    'Eastern Shore Channel': [38.50, -76.02],
    'Eastern Shore Flats': [38.38, -76.00],
    ...
    'Upper Patuxent Ponds': [38.85, -76.67],
    ...
    'Middle Patuxent': [38.56, -76.66],
    'Middle Patuxent Deep': [38.48, -76.58],
    'Middle Patuxent Channel': [38.45, -76.55],
    'Middle Patuxent Spawning': [38.52, -76.62],
